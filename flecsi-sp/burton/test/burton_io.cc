...
// register data
flecsi_register_data(mesh, io_test, pressure, real_t, dense, 1, cells);
flecsi_register_data(mesh, io_test, region, integer_t, dense, 1, cells);
flecsi_register_data(mesh, io_test, velocity, vector_t, dense, 1, vertices);
